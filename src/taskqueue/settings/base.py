"""
Django base settings for taskqueue project.
"""
...
SECRET_KEY = config("SECRET_KEY", default="test-secret-key-please-change-32bytes!!")
DEBUG = config("DEBUG", default=False, cast=bool)
ALLOWED_HOSTS = list(config("ALLOWED_HOSTS", default="", cast=Csv()))
# Railway healthchecks use this hostname; allow it so deploys can go live.
...
WSGI_APPLICATION = "taskqueue.wsgi.application"
ASGI_APPLICATION = "taskqueue.asgi.application"
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "taskqueue.apps.core.serializers.CustomTokenObtainPairSerializer",
}
